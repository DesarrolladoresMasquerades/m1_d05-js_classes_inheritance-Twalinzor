...
const carol = new Person("Carol"); // Here you see the constructor function invoked
...
console.log(snowflake.speak(), snowflake.walk());
...
console.log("Martini: ", martini.speak(), martini.walk());
